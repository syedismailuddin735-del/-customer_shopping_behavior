...
📂 Dataset
- **Size:** 3,900 customers  
- **Key Attributes:** Age group, gender, subscription status, product category, purchase amount, review rating, shipping type  
...
4. **Dashboard Creation** – Built Power BI dashboard with filters for gender, subscription, category, and shipping type.  
...
- **Sales by Category:** Clothing leads (~1,800 sales), Accessories second.  
